    ...
    <div className="container md:max-w-2xl">
      ...
      >
        ...
        <div className="relative rounded-md shadow-sm sm:min-w-0 sm:flex-1">
          ...
          <input
            className="flex h-10 w-full rounded-md border border-slate-300 bg-transparent py-2 px-3 text-sm placeholder:text-sky-900 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-slate-50 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-50 dark:focus:ring-slate-400 dark:focus:ring-offset-slate-900"
            readOnly
            value={apiKey ?? ""}
